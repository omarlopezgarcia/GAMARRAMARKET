...
/* Inserción de registros en tabla PERSONA */
...
INSERT INTO PERSONA (DNIPER, NOMPER, APEPER, EMAPER, CELPER, TIPPER, FECNACPER) VALUES 
    ('45781233','Alicia','García Campos','null','null','C','20/3/1980');
COMMIT;
...
/* Inserción de registros en tabla CATEGORIA */
...
INSERT INTO CATEGORIA(NOMCAT) VALUES('Electrodomésticos');
COMMIT;

/* Inserción de registros en tabla PRODUCTO */
...
/* Inserción de registros en tabla VENTA */
INSERT INTO VENTA (FECVEN, IDCLI, IDVEND, TIPPAGVEN) 
...
/* Inserción de registros en tabla VENTA_DETALLE */
...
/* Actualizar número de celular de Mario Rodriguez Martínez por el número 922881101 identificandolo con su DNI */
UPDATE PERSONA
...
/* Cliente con DNI 53298147 ya cuenta con número de celular es: 977226604 */
UPDATE PERSONA
...
/* Eliminado lógico a los clientes cuyo DNI son: 11453265, 15487922 y 49985471 */
UPDATE PERSONA
SET ESTPER = 'I'
...
/* Clientes cuyos DNI son: 87952514, 55869321 y 74142585 han perdido su celular por tanto debe estar en blanco */
UPDATE PERSONA
SET CELPER = 'null'
...
/* El cliente Oscar César Quiroz Zavala será reactivado y debemos actualizar su nuevo correo: oscar.quiroz@yahoo.es identificandolo con su DNI*/
UPDATE PERSONA
SET ESTPER = 'A'
WHERE DNIPER = '49985471';
COMMIT;
...
/* Eliminar fósicamente los productos de código P13, P16 y P19 */
delete FROM producto
WHERE CODPROD = 'P13';
COMMIT;
